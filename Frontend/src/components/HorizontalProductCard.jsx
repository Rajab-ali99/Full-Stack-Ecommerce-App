    ...
    return (
        <div className='container relative mx-auto px-4 py-1'>
            <div className='flex justify-between items-center'>
                ...
                <h1 className='text-mg md:text-xl font-bold my-1'>{heading}</h1>
                    ...
                    loading ? (
                        ...
                        return (
                            ...
                            <Link to={'product/' + product._id} key={index} className='h-32 md:h-36 rounded-2xl  flex min-w-[260px] md:min-w-[320px]  max-w-[260px] md:max-w-[320px]' >
                                ...
                                <div className='bg-white grid p-3 w-1/2'>
                                    <h1 className=' font-bold text-sm md:text-base text-ellipsis line-clamp-1'>{product?.productName}</h1>
